...
export const NFTCard = ({ nft, collection }) => {
  const [collectionAddress, setCollecion] = useState(collection);
      ...
      <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-md h-110 ">
        <div>
          ...
          <div className="flex flex-row">
            ...
            >
              <button onClick={() => alert("Address copied to clipboard")}>
                {" "}
                <p className="text-gray-600">
                  {`Collection address: ${nft.contract.address.substr(
                    0,
                    4
